...
<link href="https://fonts.googleapis.com/css2?family=Roboto+Condensed:ital,wght@0,100..900;1,100..900&display=swap" rel="stylesheet">
    ...
    <title>Dates</title>
    <link rel="stylesheet" href="../css/pistac.css">
...
<body>
    ...
    <div class="nigga" style="background-color: #f5f5f5; height: 100px;">
        ...
        <h2 style="padding-left: 20px; width: 20%;" >Pistachios</h2>
        <h2 style="margin-left: 65%;"><i class="fa-solid fa-house"><a href="farmer.php"><span style="font-weight: normal; font-size: small; font-family: sans-serif;"> > Products > Pistachios</span></a> </i></h2>
        </span>
    </div>
    ...
    <div class="cont" style="position: relative;padding-left: 50px;">
        <h3 style="width: 80%;font-family: sans-serif;">Pistah Suppliers in India</h3>
        <br>
        <hr>
        ...
        <div class="card" style="display: flex; justify-content: space-between;">
            <div class="cash" style=" width: 20%;">
                <img src="../assets/pista green.webp" style="width: 100%;">
                <p style="font-style: italic; color: gray; width: 100%;">Pistachios</p>
                <p style="font-weight: bold; width: 100%;">Pistachio Green Kernel ( iran) 250g</p>
                <p style="color: rgb(47, 154, 23); font-size: 18px; width: 100%;">₹70.00</p>
                <button class="bn">Add to Cart</button>
            </div>
            <div class="cash" style="width: 20%;">
                <img src="../assets/pista roast.webp" style="width: 100%;">
                <p style="font-style: italic; color: gray; width: 100%;">Pistachios</p>
                <p style="font-weight: bold; width: 100%;">Roasted Pista in Shell, 500g</p>
            ...
            <div class="cash" style="width: 20%;">
                <img src="../assets/pista green.webp" style="width: 100%;">
                <p style="font-style: italic; color: gray; width: 100%;">Pistachios</p>
                <p style="font-weight: bold; width: 100%;">Pistachio Green Kernel ( iran) 500g
                </p>
                <p style="color: rgb(47, 154, 23); font-size: 18px; width: 100%;">₹230.00</p>
                <button class="bn">Add to Cart</button>
            </div>
        ...
        <!-- <div class="card" style="display: flex; justify-content: space-between;">
            <div class="cash" style="width: 20%;">
                <img src="farddate.webp" style="width: 100%;">
                <p style="font-style: italic; color: gray; width: 100%;">Dates</p>
                <p style="font-weight: bold; width: 100%;">Fard Dates ( Date crown) 500g</p>
                <p style="color: rgb(47, 154, 23); font-size: 18px; width: 100%;">₹800.00</p>
            </div>
            <div class="cash" style="width: 20%;">
                <img src="medjouldate.webp" style="width: 100%;">
                <p style="font-style: italic; color: gray; width: 100%;">Dates</p>
                <p style="font-weight: bold; width: 100%;">Medjoul Date (king -solomon ) 500g</p>
                <p style="color: rgb(47, 154, 23); font-size: 18px; width: 100%;">₹700.00</p>
            </div> 
           
            <div class="cash" style="width: 20%;">
                <img src="wetdates.webp" style="width: 100%;">
                <p style="font-style: italic; color: gray; width: 100%;">Dates</p>
                <p style="font-weight: bold; width: 100%;">Wet Dates (Iran Palm Dates )(Grade 2) 500g</p>
                <p style="color: rgb(47, 154, 23); font-size: 18px; width: 100%;">₹85.00</p>
            </div>
            <div class="cash" style="width: 20%;">
                <img src="wetdates.webp" style="width: 100%;">
                <p style="font-style: italic; color: gray; width: 100%;">Dates</p>
                <p style="font-weight: bold; width: 100%;">Wet Dates (Iran Palm Dates )(A Grade) 500g (250gx2)</p>
                <p style="color: rgb(47, 154, 23); font-size: 18px; width: 100%;">₹120.00
                </p> -->
            </div>
