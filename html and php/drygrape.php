...
<link href="https://fonts.googleapis.com/css2?family=Roboto+Condensed:ital,wght@0,100..900;1,100..900&display=swap" rel="stylesheet">
    ...
    <link rel="stylesheet" href="../css/drygrapec.css">
...
<body>
    ...
    <div class="nigga" style="background-color: #f5f5f5; height: 100px;">
        ...
        <h2 style="padding-left: 20px; width: 20%;" >Dry Grapes</h2>
        <h2 style="margin-left: 65%;"><i class="fa-solid fa-house"><a href="farmer.php"><span style="font-weight: normal; font-size: small; font-family: sans-serif;"> > Products > Dry grapes</span></a> </i></h2>
        </span>
    </div>
    ...
    <div class="cont" style="position: relative;padding-left: 50px;">
        <h3 style="width: 80%;font-family: sans-serif;">Leading dry grapes (raisins ) suppliers in India , We are distributing best Quality Indian and Afghan raisins in India and World wide</h3>
        <br>
        <hr>
        ...
        <div class="card" style="display: flex; justify-content: space-between;">
            <div class="cash" style=" width: 20%;">
                <img src="../assets/angur.webp" style="width: 100%;">
                <p style="font-style: italic; color: gray; width: 100%;">Dry Grapes</p>
                <p style="font-weight: bold; width: 100%;">Angur Raisins (Dry Grapes)250g</p>
                <p style="color: rgb(47, 154, 23); font-size: 18px; width: 100%;">$10</p>
                <button class="bn">Add to Cart</button>
            </div>
            <div class="cash" style="width: 20%;">
                <img src="../assets/black angur.webp" style="width: 100%;">
                <p style="font-style: italic; color: gray; width: 100%;">Dry Grapes</p>
                <p style="font-weight: bold; width: 100%;">Dry Grapes (Black Seedless)1Kg</p>
                <p style="color: rgb(47, 154, 23); font-size: 18px; width: 100%;">$30</p>
                <button class="bn">Add to Cart</button>
            </div>
            <div class="cash" style="width: 20%;">
                <img src="../assets/angur.webp" style="width: 100%;">
                <p style="font-style: italic; color: gray; width: 100%;">Dry Grapes</p>
                <p style="font-weight: bold; width: 100%;">Dry Grapes (Afgan)1Kg</p>
                <p style="color: rgb(47, 154, 23); font-size: 18px; width: 100%;">$33</p>
                <button class="bn">Add to Cart</button>
            </div>
            <div class="cash" style="width: 20%;">
                <img src="../assets/angur.webp" style="width: 100%;">
                <p style="font-style: italic; color: gray; width: 100%;">Dry Grapes</p>
                <p style="font-weight: bold; width: 100%;">Dry Grapes (Golden Long)1Kg</p>
                <p style="color: rgb(47, 154, 23); font-size: 18px; width: 100%;">$37</p>
                <button class="bn">Add to Cart</button>
            </div>
        ...
        <div class="card" style="display: flex; justify-content: space-between;">
            <div class="cash" style="width: 20%;">
                <img src="../assets/black angur.webp" style="width: 100%;">
                <p style="font-style: italic; color: gray; width: 100%;">Dry Grapes</p>
                <p style="font-weight: bold; width: 100%;">Dry grapes (Black With Seed), 250g</p>
            ...
            <div class="cash" style="width: 20%;">
                <img src="../assets/black angur.webp" style="width: 100%;">
                <p style="font-style: italic; color: gray; width: 100%;">Dry Grapes</p>
                <p style="font-weight: bold; width: 100%;">Dry Grapes(afgun),250g</p>
            ...
            <div class="cash" style="width: 20%;">
                <img src="../assets/angur.webp" style="width: 100%;">
                <p style="font-style: italic; color: gray; width: 100%;">Dry Grapes</p>
                <p style="font-weight: bold; width: 100%;">Dry Grapes(Indian Nethal) 250g</p>
                <p style="color: rgb(47, 154, 23); font-size: 18px; width: 100%;">$10</p>
                <button class="bn">Add to Cart</button>
            </div>
            <div class="cash" style="width: 20%;">
                <img src="../assets/black angur.webp" style="width: 100%;">
                <p style="font-style: italic; color: gray; width: 100%;">Dry Grapes</p>
                <p style="font-weight: bold; width: 100%;">Dry grapes black (Indian) 1Kg</p>
                <p style="color: rgb(47, 154, 23); font-size: 18px; width: 100%;">$40
                </p>
                <button class="bn">Add to Cart</button>
            </div>
