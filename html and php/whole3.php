...
<link href="https://fonts.googleapis.com/css2?family=Roboto+Condensed:ital,wght@0,100..900;1,100..900&display=swap" rel="stylesheet">
    ...
    <link rel="stylesheet" href="../css/whole3c.css">
...
<body>
    <div class="whole">
        ...
        <nav class="main1">
            ...
            <ul class="first">
                ...
                <li class="three3"><a href="seedsandnut.php">Checkout</a></li>
    ...
    <div class="nigga" style="background-color: #f5f5f5; height: 100px;">
        ...
        <h2 style="padding-left: 20px; width: 20%;" >Whole spices</h2>
        <h2 style="margin-left: 65%;"><i class="fa-solid fa-house"><a href="farmer.php"><span style="font-weight: normal; font-size: small; font-family: sans-serif;"> > Products > Whole spices</span></a> </i></h2>
        </span>
    </div>
    ...
    <div class="cont" style="position: relative;padding-left: 50px;">
        <h3 style="width: 80%;font-family: sans-serif;">Wholesale spices trading company in coimbatore</h3>
        <br>
        <hr>
        ...
        <div class="card" style="display: flex; justify-content: space-between;">
            <div class="cash" style=" width: 20%;">
                <img src="../assets/black gram.webp" style="width: 100%;">
                <p style="font-style: italic; color: gray; width: 100%;">Whole Spices</p>
                <p style="font-weight: bold; width: 100%;">Black Pepper (Milagu) 12mm ,100g</p>
            ...
            <div class="cash" style="width: 20%;">
                <img src="../assets/black gram.webp" style="width: 100%;">
                <p style="font-style: italic; color: gray; width: 100%;">Whole Spices</p>
                <p style="font-weight: bold; width: 100%;">Black Pepper (Milagu) 12mm ,250g</p>
                <p style="color: rgb(47, 154, 23); font-size: 18px; width: 100%;">₹170.00</p>
                <button class="bn">Add to Cart</button>
            </div>
            <div class="cash" style="width: 20%;">
                <img src="../assets/cardamom.webp" style="width: 100%;">
                <p style="font-style: italic; color: gray; width: 100%;">Whole Spices</p>
                <p style="font-weight: bold; width: 100%;">Cardamom (Elachi ) 7.5-8mm ,250g</p>
            ...
            <div class="cash" style="width: 20%;">
                <img src="../assets/cardamom.webp" style="width: 100%;">
                <p style="font-style: italic; color: gray; width: 100%;">Whole Spices</p>
                <p style="font-weight: bold; width: 100%;">Cardamom (Elachi ) 7.5-8mm ,100g</p>
        ...
        <div class="card" style="display: flex; justify-content: space-between;">
            <div class="cash" style="width: 20%;">
                <img src="../assets/clove.webp" style="width: 100%;">
                <p style="font-style: italic; color: gray; width: 100%;">Whole Spices</p>
                <p style="font-weight: bold; width: 100%;">Clove (Krambu / Lavangam ) ,100g</p>
                <p style="color: rgb(47, 154, 23); font-size: 18px; width: 100%;">₹230.00</p>
                <button class="bn">Add to Cart</button>
            </div>
            <div class="cash" style="width: 20%;">
                <img src="../assets/mace.webp" style="width: 100%;">
                <p style="font-style: italic; color: gray; width: 100%;">Whole Spices</p>
            ...
            <div class="cash" style="width: 20%;">
                <img src="../assets/nutmeg.webp" style="width: 100%;">
                <p style="font-style: italic; color: gray; width: 100%;">Whole Spices</p>
                <p style="font-weight: bold; width: 100%;">Nutmeg( Jathikai)100g</p>
                <p style="color: rgb(47, 154, 23); font-size: 18px; width: 100%;">₹85.00</p>
                <button class="bn">Add to Cart</button>
            </div>
            <div class="cash" style="width: 20%;">
                <img src="../assets/saffron.webp" style="width: 100%;">
                <p style="font-style: italic; color: gray; width: 100%;">Whole Spices</p>
                <p style="font-weight: bold; width: 100%;">Saffron 1g</p>
                <p style="color: rgb(47, 154, 23); font-size: 18px; width: 100%;">₹120</p>
                <button class="bn">Add to Cart</button>
            </div>
