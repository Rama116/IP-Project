...
<link href="https://fonts.googleapis.com/css2?family=Roboto+Condensed:ital,wght@0,100..900;1,100..900&display=swap" rel="stylesheet">
    ...
    <link rel="stylesheet" href="../css/walc.css">
...
<body>
    <div class="whole">
        ...
        <nav class="main1">
            ...
            <ul class="first">
                ...
                <li class="three3"><a href="Almonds.php">Checkout</a></li>
    ...
    <div class="nigga" style="background-color: #f5f5f5; height: 100px;">
        ...
        <h2 style="padding-left: 20px; width: 20%;" >Walnuts</h2>
        <h2 style="margin-left: 65%;"><i class="fa-solid fa-house"><a href="farmer.php"><span style="font-weight: normal; font-size: small; font-family: sans-serif;"> > Products > Walnuts</span></a> </i></h2>
        </span>
    </div>
    ...
    <div class="cont" style="position: relative;padding-left: 50px;">
        <h3 style="width: 80%;font-family: sans-serif;">Walnuts Suppliers in Coimbatore</h3>
        <br>
        <hr>
        ...
        <div class="card" style="display: flex; justify-content: space-between;">
            <div class="cash" style=" width: 20%;">
                <img src="../assets/waln.webp" style="width: 100%;">
                <p style="font-style: italic; color: gray; width: 100%;">Walnuts</p>
                <p style="font-weight: bold; width: 100%;">Wallnut Kernal (Chile), 250g</p>
                <p style="color: rgb(47, 154, 23); font-size: 18px; width: 100%;">₹70.00</p>
                <button class="bn">Add to Cart</button>
            </div>
            <div class="cash" style="width: 20%;">
                <img src="../assets/wal kashmir.webp" style="width: 100%;">
                <p style="font-style: italic; color: gray; width: 100%;">Walnuts</p>
                <p style="font-weight: bold; width: 100%;">Whole Walnuts (Kashmir) 1Kg</p>
                <p style="color: rgb(47, 154, 23); font-size: 18px; width: 100%;">₹170.00</p>
                <button class="bn">Add to Cart</button>
            </div>
            <div class="cash" style="width: 20%;">
                <img src="../assets/wal kern.webp" style="width: 100%;">
                <p style="font-style: italic; color: gray; width: 100%;">Walnuts</p>
                <p style="font-weight: bold; width: 100%;"> Walnut Kernal (Chile ), 250g
                </p>
            ...
            <div class="cash" style="width: 20%;">
                <img src="../assets/wal kern.webp" style="width: 100%;">
                <p style="font-style: italic; color: gray; width: 100%;">Walnuts</p>
                <p style="font-weight: bold; width: 100%;">Walnut Kernal (Kashmir), 250g
                </p>
                <p style="color: rgb(47, 154, 23); font-size: 18px; width: 100%;">₹230.00</p>
                <button class="bn">Add to Cart</button>
            </div>
        ...
        <div class="card" style="display: flex; justify-content: space-between;">
            <div class="cash" style="width: 20%;">
                <img src="../assets/whole wal.webp" style="width: 100%;">
                <p style="font-style: italic; color: gray; width: 100%;">Walnuts</p>
                <p style="font-weight: bold; width: 100%;">Whole Walnut (Chile), 500g</p>
            ...
            <div class="notcash" style="width: 20%;">
                ...
                <p style="color: rgb(47, 154, 23); font-size: 22px; width: 100%;">₹700.00</p> -->
            </div> 
            ...
            <div class="notcash" style="width: 20%;">
                ...
                <p style="color: rgb(47, 154, 23); font-size: 22px; width: 100%;">₹85.00</p> -->
            </div>
            <div class="notcash" style="width: 20%;">
                <img src="" style="width: 100%;">
