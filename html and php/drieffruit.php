...
<link href="https://fonts.googleapis.com/css2?family=Roboto+Condensed:ital,wght@0,100..900;1,100..900&display=swap" rel="stylesheet">
    ...
    <link rel="stylesheet" href="../css/seedandnutc.css">
...
<body>
    ...
    <div class="nigga" style="background-color: #f5f5f5; height: 100px;">
        ...
        <h2 style="padding-left: 20px; width: 20%;" >Dried Fruits</h2>
        <h2 style="margin-left: 65%;"><i class="fa-solid fa-house"><a href="farmer.php"><span style="font-weight: normal; font-size: small; font-family: sans-serif;"> > Products > Dried Fruits</span></a> </i></h2>
        </span>
    </div>
    ...
    <div class="cont" style="position: relative;padding-left: 50px;">
        <h3 style="width: 80%;font-family: sans-serif;">Wholesale dryfruit shop in coimbatore</h3>
        <br>
        <hr>
        ...
        <div class="card" style="display: flex; justify-content: space-between;">
            <div class="cash" style=" width: 20%;">
                <img src="../assets/driedanjeer.webp" style="width: 100%;">
                <p style="font-style: italic; color: gray; width: 100%;">Dried Fruits</p>
                <p style="font-weight: bold; width: 100%;">Anjeer ( Dried Figs ) (Premium), 250g</p>
            ...
            <div class="cash" style="width: 20%;">
                <img src="../assets/driedanjeer.webp" style="width: 100%;">
                <p style="font-style: italic; color: gray; width: 100%;">Dried Fruits</p>
                <p style="font-weight: bold; width: 100%;">Anjeer ( Dried Figs ) (Premium), 150g</p>
            ...
            <div class="cash" style="width: 20%;">
                ...
                <p style="font-weight: bold; width: 100%;"> 
                    Anjeer ( Dried Figs ) (Medium), 250g
                </p>
                <p style="color: rgb(47, 154, 23); font-size: 18px; width: 100%;">₹230.00</p>
                <button class="bn">Add to Cart</button>
            </div>
            <div class="cash" style="width: 20%;">
                <img src="../assets/driedapricot.webp" style="width: 100%;">
                <p style="font-style: italic; color: gray; width: 100%;">Dried Fruits</p>
                <p style="font-weight: bold; width: 100%;">Apricot 150g
                </p>
                <p style="color: rgb(47, 154, 23); font-size: 18px; width: 100%;">₹230.00</p>
                <button class="bn">Add to Cart</button>
            </div>
        ...
        <div class="card" style="display: flex; justify-content: space-between;">
            <div class="cash" style="width: 20%;">
                <img src="../assets/driedamla.webp" style="width: 100%;">
                <p style="font-style: italic; color: gray; width: 100%;">Dried Fruits</p>
                <p style="font-weight: bold; width: 100%;">Dried amla (Sweet) 250g</p>
                <p style="color: rgb(47, 154, 23); font-size: 18px; width: 100%;">₹800.00</p>
                <button class="bn">Add to Cart</button>
            </div>
            <div class="cash" style="width: 20%;">
                <img src="../assets/driedkiwi.webp" style="width: 100%;">
                <p style="font-style: italic; color: gray; width: 100%;">Dried Fruits</p>
                <p style="font-weight: bold; width: 100%;">Dried Kiwi, 200g</p>
            ...
            <div class="cash" style="width: 20%;">
                ...
                <!-- <p style="font-style: italic; color: gray; width: 100%;">Seeds & nuts</p>
                <p style="font-weight: bold; width: 100%;">Pumpkin seeds 250g</p>
                <p style="color: rgb(47, 154, 23); font-size: 18px; width: 100%;">₹85.00</p> -->
            </div>
            <div class="cash" style="width: 20%;">
                <img src="" style="width: 100%;">
                <!-- <p style="font-style: italic; color: gray; width: 100%;">Seeds & nuts</p>
                <p style="font-weight: bold; width: 100%;">Pumpkin seeds 500g</p>
